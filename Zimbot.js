// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮SAK BOT 2022 ®️ALL RIGHTS RESERVED
//▮
...
//▮YOUTUBE CHANNELL: https://www.youtube.com/channel/UCYEKB_cqPyl2yKW21nknGfw
//▮
//╰▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
//
//┏━━━━━━━━━━━━━━━━━━━━━━━━━
...
urlButton: {
displayText: `GITHUB`, 
url: `https://github.com/nimaofficial/SAK-BOT-MD/fork`
}
}, {
quickReplyButton: {
displayText: `VIDEO`,
...
let buttons = [{
 urlButton: {
  displayText: 'REPORT',
  url: 'https://wa.me/+94786802371?text=hello+bro+i+found+a+bug+in+your+bot'
 }
  }, {
 quickReplyButton: {
  displayText: 'START',
...
{ buttonId: 'keluar', buttonText: { displayText: 'STOP' }, type: 1 }
 ...
 case 'public': {
   ...
   reply('Sak 𝗯𝗼𝘁 𝗻𝗼𝘄 𝘄𝗼𝗿𝗸𝗶𝗻𝗴 𝗮𝘀 𝗽𝘂𝗯𝗹𝗶𝗰')
...
/*case 'ripmaker':
 ...
 case 'self': {
   ...
   reply('Sak 𝗯𝗼𝘁 𝗻𝗼𝘄 𝘄𝗼𝗿𝗸𝗶𝗻𝗴 𝗮𝘀 𝗽𝗿𝗶𝘃𝗮𝘁𝗲')
 }
 break
...
huso = await getBuffer(picak+'SAK BOT MD IS ALIVE')
 ...
 *ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}
 ...
 └───────────●
        `,
         buttonText: "SET MENU",
         footerText: "SAK BOT MD",
         listType: "SINGLE_SELECT",
         sections: [{
       "title": "SAK BOT MD",
       "rows": [
       {
       "title": "TEMPLATE SAK BOT MD",
...
%readmore` 
    ...
    urlButton: {
    displayText: 'GITHUB',
    url: 'https://github.com/nimaofficial/SAK-BOT-MD
    }, {
    quickReplyButton: {
    displayText: 'SPEED',
    id: 'ping'
